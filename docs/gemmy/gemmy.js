...
/* Generated by Opal 0.7.1 */
Opal.modules["gremlin/version"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module;
...
/* Generated by Opal 0.7.1 */
Opal.modules["gremlin/vec2"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass;

  Opal.add_stubs(['$attr_accessor', '$x=', '$y=', '$x', '$y', '$+', '$-', '$*', '$[]', '$edistance_to', '$==', '$^', '$hash', '$new', '$class', '$lerp', '$size', '$raise', '$<=', '$>=']);
  return (function($base) {
    var self = $module($base, 'Gremlin');
    ...
    (function($base, $super) {
      function $Vec2(){};
      var self = $Vec2 = $klass($base, $super, 'Vec2', $Vec2);

      var def = self.$$proto, $scope = self.$$scope;

      self.$attr_accessor("x", "y");

      def['$eset!'] = function(x, y) {
        var $a, $b, self = this;

        (($a = [x]), $b = self, $b['$x='].apply($b, $a), $a[$a.length-1]);
        return (($a = [y]), $b = self, $b['$y='].apply($b, $a), $a[$a.length-1]);
      };

      def['$set!'] = function(other) {
        var $a, $b, self = this;

        (($a = [other.$x()]), $b = self, $b['$x='].apply($b, $a), $a[$a.length-1]);
        return (($a = [other.$y()]), $b = self, $b['$y='].apply($b, $a), $a[$a.length-1]);
      };

      def['$add!'] = function(other) {
        var $a, self = this;

        ($a = self, $a['$x=']($a.$x()['$+'](other.$x())));
        return ($a = self, $a['$y=']($a.$y()['$+'](other.$y())));
      };

      def['$eadd!'] = function(x, y) {
        var $a, self = this;

        ($a = self, $a['$x=']($a.$x()['$+'](x)));
        return ($a = self, $a['$y=']($a.$y()['$+'](y)));
      };
      ...
      def['$mul!'] = function(scalar) {
        var $a, self = this;

        ($a = self, $a['$x=']($a.$x()['$*'](scalar)));
        return ($a = self, $a['$y=']($a.$y()['$*'](scalar)));
      };

      def['$+'] = function(other) {
        var self = this;

        return $scope.get('Vec2')['$[]'](self.$x()['$+'](other.$x()), self.$y()['$+'](other.$y()));
      };
      ...
      def['$*'] = function(scalar) {
        ...
        return $scope.get('Vec2')['$[]'](scalar['$*'](self.$x()), scalar['$*'](self.$y()));
      };
      ...
      def.$length = function() {
        ...
        return self.$edistance_to(0, 0);
      };

      def['$=='] = function(other) {
        var $a, self = this;

        return (($a = self.$x()['$=='](other.$x())) ? self.$y()['$=='](other.$y()) : $a);
      };
      ...
      def['$eeql?'] = function(x, y) {
        var $a, self = this;

        return (($a = self.$x()['$=='](x)) ? self.$y()['$=='](y) : $a);
      };
      ...
      def.$distance_to = function(other) {
        var self = this;

        return self.$edistance_to(other.$x(), other.$y());
      };

      def.$edistance_to = function(ox, oy) {
        var self = this;

        return Math.sqrt(Math.pow(self.$x() - ox, 2) + Math.pow(self.$y() - oy, 2));
      };

      def.$lerp_to = function(other, fraction) {
        var self = this;

        return self.$class().$lerp(self, other, fraction);
      };
      ...
      return (function(self) {
        ...
        self.$$proto.$new = function(x, y) {
          var self = this;

          return new PIXI.Point(x, y);
        };
        self.$$proto['$[]'] = function(x, y) {
          var self = this;

          return self.$new(x, y);
        };
        self.$$proto.$from_a = function(array) {
          var $a, self = this;
          ...
          return ($a = self).$new.apply($a, [].concat(array));
        };
        return (self.$$proto.$lerp = function(from, to, fraction) {
          var self = this;

          return (function() {if (fraction['$<='](0.0)) {return from}else if (fraction['$>='](1.0)) {return to}else {return self.$new($scope.get('Gremlin').$lerp(from.$x(), to.$x(), fraction), $scope.get('Gremlin').$lerp(from.$y(), to.$y(), fraction))}})();
        }, nil) && 'lerp';
      })(self.$singleton_class());
    })(self, PIXI.Point)
  })(self)
...
/* Generated by Opal 0.7.1 */
Opal.modules["gremlin/display_object"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass;
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      var self = $DisplayObject = $klass($base, $super, 'DisplayObject', $DisplayObject);

      var def = self.$$proto, $scope = self.$$scope;

      def.parent = nil;
      self.$attr_accessor("position", "scale", "pivot", "rotation", "alpha", "visible", "renderable");

      return (def.$bring_to_top = function() {
        var self = this;

        return self.parent.bringToTop(self);
      }, nil) && 'bring_to_top';
    })(self, PIXI.DisplayObject)
  })(self)
};

/* Generated by Opal 0.7.1 */
Opal.modules["gremlin/keyboard"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module;

  Opal.add_stubs(['$const_set', '$+']);
  return (function($base) {
    var self = $module($base, 'Gremlin');
    ...
    (function($base) {
      ...
      for(var k in Phaser.Keyboard){
        if(Phaser.Keyboard.hasOwnProperty(k)){
          if(k === k.toUpperCase()){
            self.$const_set("KEY_"['$+'](k), Phaser.Keyboard[k])
          }
        }
      }
    ;
...
/* Generated by Opal 0.7.1 */
Opal.modules["gremlin/pointer"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass;
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      function $Pointer(){};
      var self = $Pointer = $klass($base, $super, 'Pointer', $Pointer);
...
/* Generated by Opal 0.7.1 */
Opal.modules["gremlin/game"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  ...
  Opal.add_stubs(['$raise', '$to_n', '$[]', '$protected', '$attr_accessor', '$init', '$each', '$normalize_asset_manifest', '$assets', '$add_text', '$eset!', '$position', '$scale', '$*', '$destroy!', '$create', '$render', '$update', '$paused', '$pause_update', '$resize', '$shutdown', '$private', '$key_down', '$key_up', '$pointer_down', '$set!', '$position_up', '$pointer_up', '$flat_map', '$normalize_asset', '$map', '$rjust', '$to_s', '$+', '$times', '$is_a?', '$size', '$===', '$first', '$last', '$include?', '$item', '$fail', '$inspect']);
  return (function($base) {
    var self = $module($base, 'Gremlin');
    ...
    (function($base, $super) {
      ...
      def.$add_text = function(text, style) {
        ...
        return self.add.text(0, 0, text, style.$to_n());
      };

      def.$play_sound = function(key, looping) {
        var self = this, s = nil;
      ...
      def.$get_text = function(key) {
        var self = this;

        return self.cache.getText(key);
      };
      ...
      def.$canvas_size = function() {
        ...
        return $scope.get('Vec2')['$[]'](self.game.width, self.game.height);
      };

      def.$delta_time = function() {
        var self = this;

        return self.time.physicsElapsed;
      };

      def.$average_fps = function() {
        var self = this;

        return self.time.fps;
      };

      def['$enabled_advanced_timing!'] = function() {
        var self = this;

        return self.time.advancedTiming = true;
      };
      ...
      def.$phaser_preload = function() {
        var $a, $b, TMP_1, self = this;

        return ($a = ($b = self.$normalize_asset_manifest(self.$assets())).$each, $a.$$p = (TMP_1 = function(type, key, url){var self = TMP_1.$$s || this;
if (type == null) type = nil;if (key == null) key = nil;if (url == null) url = nil;
        return self.load[type](key, url);}, TMP_1.$$s = self, TMP_1), $a).call($b);
      };

      def.$phaser_load_update = function() {
        var $a, self = this, progress = nil;

        if ((($a = self.state._created) !== nil && (!$a.$$is_boolean || $a == true))) {
          return nil};
        if ((($a = self._loading_text) !== nil && (!$a.$$is_boolean || $a == true))) {
          } else {
          self._loading_text = self.$add_text("Loading...", $hash2(["fill"], {"fill": "white"}));
          self._loading_text.$position()['$eset!'](15, 15);
          self._loading_bar = self.add.graphics(0,0);
          self._loading_bar.beginFill(0xFFFFFF, 1);
          self._loading_bar.drawRect(0, 0, 1, 10);
          self._loading_bar.endFill();
        };
        progress = self.load.progress / 100;
        return self._loading_bar.$scale()['$eset!'](progress['$*'](self.game.width), 1);
      };

      def.$phaser_create = function() {
        var $a, self = this;

        if ((($a = self._loading_text) !== nil && (!$a.$$is_boolean || $a == true))) {
          self._loading_text['$destroy!']()};
        if ((($a = self._loading_bar) !== nil && (!$a.$$is_boolean || $a == true))) {
          self._loading_bar['$destroy!']()};
        return self.$create();
      };

      def.$phaser_render = function() {
        var self = this;

        return self.$render();
      };

      def.$phaser_update = function() {
        var self = this;

        return self.$update();
      };

      def.$phaser_paused = function() {
        var self = this;

        return self.$paused();
      };

      def.$phaser_pause_update = function() {
        var self = this;

        return self.$pause_update();
      };

      def.$phaser_resize = function() {
        var self = this;

        return self.$resize();
      };

      def.$phaser_shutdown = function() {
        var self = this;
      ...
      def.$_handle_key_down = function(event) {
        var self = this;

        return self.$key_down(event.keyCode);
      };

      def.$_handle_key_up = function(event) {
        var self = this;

        return self.$key_up(event.keyCode);
      };

      def.$_handle_pointer_down = function(pointer, event) {
        var self = this;

        return self.$pointer_down(pointer);
      };

      def.$_handle_pointer_up = function(pointer, event) {
        var self = this;

        pointer.$position_up()['$set!'](pointer.$position());
        return self.$pointer_up(pointer);
      };

      def['$patch_phaser_methods!'] = function() {
        var $a, $b, TMP_2, self = this;

        return ($a = ($b = $scope.get('PATCHED_METHODS')).$each, $a.$$p = (TMP_2 = function(opal_key, js_key){var self = TMP_2.$$s || this;
if (opal_key == null) opal_key = nil;if (js_key == null) js_key = nil;
        return self[js_key] = self["$" + opal_key];}, TMP_2.$$s = self, TMP_2), $a).call($b);
      };

      def.$normalize_asset_manifest = function(assets_by_type) {
        var $a, $b, TMP_3, self = this;

        return ($a = ($b = assets_by_type).$flat_map, $a.$$p = (TMP_3 = function(type, asset_list){var self = TMP_3.$$s || this, $a, $b, TMP_4;
if (type == null) type = nil;if (asset_list == null) asset_list = nil;
        return ($a = ($b = asset_list).$flat_map, $a.$$p = (TMP_4 = function(asset){var self = TMP_4.$$s || this, $a, $b, TMP_5, key = nil, count = nil, ext = nil;
if (asset == null) asset = nil;
          $a = Opal.to_ary(self.$normalize_asset(asset)), key = ($a[0] == null ? nil : $a[0]), count = ($a[1] == null ? nil : $a[1]), ext = ($a[2] == null ? nil : $a[2]);
            ((($a = ext) !== false && $a !== nil) ? $a : ext = $scope.get('DEFAULT_EXTENSIONS')['$[]'](type));
            if (count !== false && count !== nil) {
              return ($a = ($b = count.$times()).$map, $a.$$p = (TMP_5 = function(idx){var self = TMP_5.$$s || this, num = nil;
if (idx == null) idx = nil;
              num = (idx['$+'](1)).$to_s().$rjust(2, "0");
                return [type, key['$+'](idx.$to_s()), "asset/" + (type) + "/" + (key) + "_" + (num) + "." + (ext)];}, TMP_5.$$s = self, TMP_5), $a).call($b)
              } else {
              return [[type, key, "asset/" + (type) + "/" + (key) + "." + (ext)]]
            };}, TMP_4.$$s = self, TMP_4), $a).call($b)}, TMP_3.$$s = self, TMP_3), $a).call($b);
      };

      def.$normalize_asset = function(asset) {
        var $a, self = this, $case = nil;

        if ((($a = asset['$is_a?']($scope.get('String'))) !== nil && (!$a.$$is_boolean || $a == true))) {
          return [asset, nil, nil]
          } else {
          return (function() {$case = asset.$size();if ((1)['$===']($case)) {return [asset.$first(), nil, nil]}else if ((2)['$===']($case)) {if ((($a = asset.$last()['$is_a?']($scope.get('Integer'))) !== nil && (!$a.$$is_boolean || $a == true))) {
            return [asset.$first(), asset.$last(), nil]
            } else {
            return [asset.$first(), nil, asset.$last()]
          }}else if ((3)['$===']($case)) {return asset}else {if ((($a = ($range(1, 3, false))['$include?'](self.$item().$size())) !== nil && (!$a.$$is_boolean || $a == true))) {
            return nil
            } else {
            return self.$fail("Invalid asset: " + (self.$item().$inspect()))
          }}})()
        };
      };

      Opal.cdecl($scope, 'PATCHED_METHODS', $hash2(["phaser_init", "phaser_preload", "phaser_load_render", "phaser_load_update", "phaser_create", "phaser_update", "phaser_render", "phaser_paused", "phaser_pause_update", "phaser_resize", "phaser_shutdown"], {"phaser_init": "init", "phaser_preload": "preload", "phaser_load_render": "loadRender", "phaser_load_update": "loadUpdate", "phaser_create": "create", "phaser_update": "update", "phaser_render": "render", "phaser_paused": "paused", "phaser_pause_update": "pauseUpdate", "phaser_resize": "resize", "phaser_shutdown": "shutdown"}));

      return Opal.cdecl($scope, 'DEFAULT_EXTENSIONS', $hash2(["image", "text", "audio"], {"image": "png", "text": "txt", "audio": "wav"}));
    })(self, Phaser.State)
  })(self)
};

/* Generated by Opal 0.7.1 */
Opal.modules["gremlin/sprite"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass;

  Opal.add_stubs(['$[]', '$width', '$height']);
  return (function($base) {
    var self = $module($base, 'Gremlin');
...
/* Generated by Opal 0.7.1 */
Opal.modules["gremlin/text"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass;
...
/* Generated by Opal 0.7.1 */
Opal.modules["gremlin/graphics"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass;
  ...
  return (function($base) {
    ...
    })(self, Phaser.Graphics)
  })(self)
};

/* Generated by Opal 0.7.1 */
Opal.modules["gremlin"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  ...
  self.$require("gremlin/vec2");
  self.$require("gremlin/display_object");
  self.$require("gremlin/keyboard");
  self.$require("gremlin/pointer");
  self.$require("gremlin/game");
  self.$require("gremlin/sprite");
  self.$require("gremlin/text");
  self.$require("gremlin/graphics");
  return (function($base) {
    var self = $module($base, 'Gremlin');

    var def = self.$$proto, $scope = self.$$scope;

    Opal.defs(self, '$lerp', function(from, to, fraction) {
      var self = this;

      return (function() {if (fraction['$<='](0.0)) {return from}else if (fraction['$>='](1.0)) {return to}else {return from['$+'](fraction['$*']((to['$-'](from))))}})();
    });
    ...
    Opal.defs(self, '$run_game', function(game_class, options) {
      ...
      parent = ((($a = options['$[]']("parent")) !== false && $a !== nil) ? $a : undefined);
      transparent = ((($a = options['$[]']("transparent")) !== false && $a !== nil) ? $a : undefined);
      antialias = ((($a = options['$[]']("antialias")) !== false && $a !== nil) ? $a : undefined);
      physics_config = ((($a = options['$[]']("physics_config")) !== false && $a !== nil) ? $a : undefined);
      return new Phaser.Game(width, height, renderer, parent, state, transparent, antialias, physics_config);
    });

    Opal.cdecl($scope, 'RENDERERS', $hash2(["auto", "canvas", "webgl", "headless"], {"auto": Phaser.AUTO, "canvas": Phaser.CANVAS, "webgl": Phaser.WEBGL, "headless": Phaser.HEADLESS}));
  })(self);
};
...
(function(Opal) {
  ...
  (function($base, $super) {
    ...
    return (def.$pointer_up = function(pointer) {
      var self = this;
  ...
  (function($base, $super) {
    ...
    def.$initialize = function() {
      ...
      return self.initial_scene = $scope.get('IntroScene').$new();
    };

    def.$assets = function() {
      var self = this;

      return $hash2(["image", "text", "audio"], {"image": ["intro_background", ["dirtball", 1], ["bullet", 1], ["player", 3], ["chaser", 3], ["wall", 4], ["goal", 3], ["floor", 4], ["shooter", 5], ["teleporter", 4]], "text": [["level", $scope.get('NUM_LEVELS')]], "audio": ["lose", "move", "start", "win", ["music", "mp3"]]});
    };

    def.$create = function() {
      var self = this;

      return self.$transition_to_scene(self.initial_scene);
    };

    def.$key_down = function(key) {
      var $a, $b, TMP_1, self = this;

      return ($a = ($b = self).$maybe_transition, $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this;
        if (self.scene == null) self.scene = nil;

      return self.scene.$key_down(key)}, TMP_1.$$s = self, TMP_1), $a).call($b);
    };

    def.$key_up = function(key) {
      var $a, $b, TMP_2, self = this;

      return ($a = ($b = self).$maybe_transition, $a.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this;
        if (self.scene == null) self.scene = nil;

      return self.scene.$key_up(key)}, TMP_2.$$s = self, TMP_2), $a).call($b);
    };

    def.$pointer_down = function(pointer) {
      var $a, $b, TMP_3, self = this;

      return ($a = ($b = self).$maybe_transition, $a.$$p = (TMP_3 = function(){var self = TMP_3.$$s || this;
        if (self.scene == null) self.scene = nil;

      return self.scene.$pointer_down(pointer)}, TMP_3.$$s = self, TMP_3), $a).call($b);
    };
    ...
    def.$pointer_up = function(pointer) {
      ...
      return self.scene.$pointer_up(pointer)}, TMP_4.$$s = self, TMP_4), $a).call($b);
    };
    ...
    def.$update = function() {
      ...
      return self.scene.$update()}, TMP_5.$$s = self, TMP_5), $a).call($b);
    };
    ...
    def.$maybe_transition = TMP_6 = function() {
      var $yielded, self = this, $iter = TMP_6.$$p, $yield = $iter || nil;

      TMP_6.$$p = null;
      if (($yielded = Opal.yieldX($yield, [])) === $breaker) return $breaker.$v;return self.$transition_to_scene($yielded);
    };

    return (def.$transition_to_scene = function(scene) {
      var $a, $b, $c, $d, self = this;

      while ((($b = ($c = (($d = scene !== false && scene !== nil) ? self['$native?'](scene)['$!']() : $d), $c !== false && $c !== nil ?scene['$is_a?']($scope.get('Scene')) : $c)) !== nil && (!$b.$$is_boolean || $b == true))) {
      if ((($b = self.scene) !== nil && (!$b.$$is_boolean || $b == true))) {
        self.scene.$shutdown();
        (($b = [nil]), $c = self.scene, $c['$game='].apply($c, $b), $b[$b.length-1]);};
      self.game.world.shutdown();
      self.scene = scene;
      (($b = [self]), $c = self.scene, $c['$game='].apply($c, $b), $b[$b.length-1]);
      scene = self.scene.$startup();};
    }, nil) && 'transition_to_scene';
  })(self, (($scope.get('Gremlin')).$$scope.get('Game')));
  (function($base) {
    var self = $module($base, 'DefStruct');

    var def = self.$$proto, $scope = self.$$scope, TMP_7;

    Opal.defs(self, '$new', TMP_7 = function() {
      var $a, $b, TMP_8, self = this, $iter = TMP_7.$$p, defaults_block = $iter || nil, defaults = nil, klass = nil;

      TMP_7.$$p = null;
      defaults = defaults_block.$call();
      klass = ($a = ($b = $scope.get('Struct')).$new, $a.$$p = (TMP_8 = function(){var self = TMP_8.$$s || this, TMP_10;

      Opal.defn(self, '$initialize', function(attrs) {
          var $a, $b, TMP_9, self = this, defaults = nil;

          if (attrs == null) {
            attrs = $hash2([], {})
          }
          defaults = self.$class().$const_get("DEFAULTS_BLOCK").$call();
          return ($a = ($b = defaults['$merge!'](attrs)).$each, $a.$$p = (TMP_9 = function(k, v){var self = TMP_9.$$s || this;
if (k == null) k = nil;if (v == null) v = nil;
          return self['$[]='](k, v)}, TMP_9.$$s = self, TMP_9), $a).call($b);
        });
        return (Opal.defs(self, '$reopen', TMP_10 = function() {
          var $a, $b, self = this, $iter = TMP_10.$$p, block = $iter || nil;

          TMP_10.$$p = null;
          ($a = ($b = self).$class_exec, $a.$$p = block.$to_proc(), $a).call($b);
          return self;
        }), nil) && 'reopen';}, TMP_8.$$s = self, TMP_8), $a).apply($b, [].concat(defaults.$keys()));
      klass.$const_set("DEFAULTS_BLOCK", defaults_block);
      return klass;
    })
  })(self);
  Opal.cdecl($scope, 'Animation', ($a = ($b = $scope.get('DefStruct')).$new, $a.$$p = (TMP_11 = function(){var self = TMP_11.$$s || this;

  return $hash2(["image_key", "current_frame", "secs_per_frame", "secs_elapsed_this_frame"], {"image_key": nil, "current_frame": 0, "secs_per_frame": 0.3, "secs_elapsed_this_frame": 0})}, TMP_11.$$s = self, TMP_11), $a).call($b));
  Opal.cdecl($scope, 'Entity', ($a = ($c = $scope.get('DefStruct')).$new, $a.$$p = (TMP_12 = function(){var self = TMP_12.$$s || this;

  return $hash2(["sprite", "sort_order", "pos", "pos_fraction", "ai", "color", "tint", "image_key", "image_frame", "animation", "alive", "orientation", "pushable", "teleport_pair", "just_teleported", "deadly"], {"sprite": nil, "sort_order": 0, "pos": $scope.get('Vec2')['$[]'](0, 0), "pos_fraction": $scope.get('Vec2')['$[]'](0, 0), "ai": nil, "color": "white", "tint": "white", "image_key": nil, "image_frame": 0, "animation": nil, "alive": true, "orientation": "north", "pushable": false, "teleport_pair": nil, "just_teleported": false, "deadly": true})}, TMP_12.$$s = self, TMP_12), $a).call($c));
  Opal.cdecl($scope, 'Movement', ($a = ($d = $scope.get('DefStruct')).$new, $a.$$p = (TMP_13 = function(){var self = TMP_13.$$s || this;

  return $hash2(["entity", "from"], {"entity": nil, "from": $scope.get('Vec2')['$[]'](0, 0)})}, TMP_13.$$s = self, TMP_13), $a).call($d));
  Opal.cdecl($scope, 'MovementSet', ($a = ($e = $scope.get('DefStruct')).$new, $a.$$p = (TMP_14 = function(){var self = TMP_14.$$s || this;

  return $hash2(["movements", "progress"], {"movements": [], "progress": 0.0})}, TMP_14.$$s = self, TMP_14), $a).call($e));
  Opal.cdecl($scope, 'GameState', ($a = ($f = $scope.get('DefStruct')).$new, $a.$$p = (TMP_15 = function(){var self = TMP_15.$$s || this;

  return $hash2(["level", "player", "goal", "entities", "movement_sets"], {"level": nil, "player": nil, "goal": nil, "entities": [], "movement_sets": []})}, TMP_15.$$s = self, TMP_15), $a).call($f));
  Opal.cdecl($scope, 'AiResults', ($a = ($g = $scope.get('DefStruct')).$new, $a.$$p = (TMP_16 = function(){var self = TMP_16.$$s || this;

  return $hash2(["moves", "spawns", "kills"], {"moves": [], "spawns": [], "kills": []})}, TMP_16.$$s = self, TMP_16), $a).call($g));
  Opal.cdecl($scope, 'Cell', ($a = ($h = $scope.get('DefStruct')).$new, $a.$$p = (TMP_17 = function(){var self = TMP_17.$$s || this;

  return $hash2(["type", "image_frame", "orientation", "sprite"], {"type": "none", "image_frame": 0, "orientation": "north", "sprite": nil})}, TMP_17.$$s = self, TMP_17), $a).call($h));
  Opal.cdecl($scope, 'Level', ($a = ($i = ($j = ($k = $scope.get('DefStruct')).$new, $j.$$p = (TMP_24 = function(){var self = TMP_24.$$s || this;

  return $hash2(["rows", "entities"], {"rows": [], "entities": []})}, TMP_24.$$s = self, TMP_24), $j).call($k)).$reopen, $a.$$p = (TMP_18 = function(){var self = TMP_18.$$s || this, TMP_23;

  Opal.defs(self, '$from_text', function(file_string) {
      var $a, $b, TMP_19, self = this, rows = nil;

      rows = ($a = ($b = file_string.$lines()).$map, $a.$$p = (TMP_19 = function(line){var self = TMP_19.$$s || this, $a, $b, TMP_20;
if (line == null) line = nil;
      return ($a = ($b = line.$chomp("\n").$each_char()).$map, $a.$$p = (TMP_20 = function(char$){var self = TMP_20.$$s || this;
if (char$ == null) char$ = nil;
        return $scope.get('Cell').$new($hash2(["type"], {"type": $scope.get('CELL_TYPES_BY_CHAR').$fetch(char$)}))}, TMP_20.$$s = self, TMP_20), $a).call($b)}, TMP_19.$$s = self, TMP_19), $a).call($b);
      return self.$new($hash2(["rows"], {"rows": rows}));
    });
    Opal.defn(self, '$each_cell', TMP_23 = function() {
      var $a, $b, TMP_21, self = this, $iter = TMP_23.$$p, $yield = $iter || nil;

      TMP_23.$$p = null;
      return ($a = ($b = self.$rows()).$each_with_index, $a.$$p = (TMP_21 = function(row, row_idx){var self = TMP_21.$$s || this, $a, $b, TMP_22;
if (row == null) row = nil;if (row_idx == null) row_idx = nil;
      return ($a = ($b = row).$each_with_index, $a.$$p = (TMP_22 = function(cell, col_idx){var self = TMP_22.$$s || this, $a;
if (cell == null) cell = nil;if (col_idx == null) col_idx = nil;
        return $a = Opal.yieldX($yield, [$scope.get('Vec2')['$[]'](col_idx, row_idx), cell]), $a === $breaker ? $a : $a}, TMP_22.$$s = self, TMP_22), $a).call($b)}, TMP_21.$$s = self, TMP_21), $a).call($b);
    });
    ...
    Opal.defn(self, '$row_count', function() {
      var self = this;

      return self.$rows().$size();
    });
    Opal.defn(self, '$column_count', function() {
      var self = this;

      return self.$rows().$first().$size();
    });
    return (Opal.defn(self, '$can_move_to?', function(x, y) {
      var self = this, cell = nil;

      cell = self.$cell_at(x, y);
      return cell.$type()['$==']("floor");
    }), nil) && 'can_move_to?';}, TMP_18.$$s = self, TMP_18), $a).call($i));
  Opal.Object.$$proto.$orientation_for_movement = function(x, y) {
    var self = this;

    return (function() {if (x['$>'](0)) {return "east"}else if (x['$<'](0)) {return "west"}else if (y['$>'](0)) {return "south"}else {return "north"}})();
  };
  (function($base, $super) {
    function $ChaserAi(){};
    var self = $ChaserAi = $klass($base, $super, 'ChaserAi', $ChaserAi);

    var def = self.$$proto, $scope = self.$$scope;

    return (def.$think = function(chaser, game) {
      var self = this, e = nil, p = nil, dist = nil, moves = nil;
      ...
      if (dist['$<'](3.5)) {
        if (e.$x()['$<'](p.$x())) {
          moves['$<<']($scope.get('Vec2')['$[]'](1, 0))};
        if (e.$x()['$>'](p.$x())) {
          moves['$<<']($scope.get('Vec2')['$[]'](-1, 0))};
        if (e.$y()['$>'](p.$y())) {
          moves['$<<']($scope.get('Vec2')['$[]'](0, -1))};
        if (e.$y()['$<'](p.$y())) {
          moves['$<<']($scope.get('Vec2')['$[]'](0, 1))};};
      return $scope.get('AiResults').$new($hash2(["moves"], {"moves": moves}));
    }, nil) && 'think'
  })(self, null);
  (function($base, $super) {
    function $ShooterAi(){};
    var self = $ShooterAi = $klass($base, $super, 'ShooterAi', $ShooterAi);
    ...
    return (def.$think = function(shooter, game) {
      var $a, $b, self = this, p = nil, s = nil, projectile_vel = nil;

      if ((($a = ($b = self.projectile, $b !== false && $b !== nil ?self.projectile.$alive()['$!']() : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
        self.projectile = nil};
      if ((($a = self.projectile) !== nil && (!$a.$$is_boolean || $a == true))) {
        return nil};
      p = game.$player().$pos();
      s = shooter.$pos();
      projectile_vel = (function() {if (p.$x()['$=='](s.$x())) {return $scope.get('Vec2')['$[]'](0, ((function() {if (p.$y()['$<'](s.$y())) {
        return -1
        } else {
        return 1
      }; return nil; })()))}else if (p.$y()['$=='](s.$y())) {return $scope.get('Vec2')['$[]'](((function() {if (p.$x()['$<'](s.$x())) {
        return -1
        } else {
        return 1
      ...
      if (projectile_vel !== false && projectile_vel !== nil) {
        ...
        return $scope.get('AiResults').$new($hash2(["spawns"], {"spawns": [self.projectile]}));
        } else {
        return $scope.get('AiResults').$new()
      };
    }, nil) && 'think';
  })(self, null);
  (function($base, $super) {
    function $ProjectileAi(){};
    var self = $ProjectileAi = $klass($base, $super, 'ProjectileAi', $ProjectileAi);

    var def = self.$$proto, $scope = self.$$scope;

    def.velocity = nil;
    def.$initialize = function(velocity) {
      var self = this;
    ...
    return (def.$think = function(projectile, game) {
      var $a, $b, $c, TMP_25, self = this, new_pos = nil, kills = nil;

      new_pos = projectile.$pos()['$+'](self.velocity);
      if ((($a = ($b = game.$level())['$can_move_to?'].apply($b, [].concat(new_pos.$to_a()))) !== nil && (!$a.$$is_boolean || $a == true))) {
        kills = ($a = ($c = game.$entities()).$select, $a.$$p = (TMP_25 = function(e){var self = TMP_25.$$s || this;
if (e == null) e = nil;
        return e.$pos()['$=='](new_pos)}, TMP_25.$$s = self, TMP_25), $a).call($c);
        if (kills.$size()['$>'](0)) {
          kills['$<<'](projectile)};
        return $scope.get('AiResults').$new($hash2(["moves", "kills"], {"moves": [self.velocity], "kills": kills}));
        } else {
        return $scope.get('AiResults').$new($hash2(["kills"], {"kills": [projectile]}))
      };
    }, nil) && 'think';
  })(self, null);
  (function($base, $super) {
    function $LevelScene(){};
    var self = $LevelScene = $klass($base, $super, 'LevelScene', $LevelScene);

    var def = self.$$proto, $scope = self.$$scope;

    def.level_number = def.state = def.level_number_text = nil;
    Opal.cdecl($scope, 'ENTITY_SORT_ORDER', ["dirtball", "enemy", "player"]);

    def.$initialize = function(level_number) {
      var self = this;

      return self.level_number = level_number;
    };

    def.$so = function(type) {
      var $a, self = this;

      return ((($a = $scope.get('ENTITY_SORT_ORDER').$index(type)) !== false && $a !== nil) ? $a : $scope.get('ENTITY_SORT_ORDER').$size());
    };

    def.$startup = function() {
      var $a, $b, TMP_26, $c, TMP_27, $d, TMP_28, $e, TMP_29, $f, $g, self = this, level_text = nil, all_entities = nil;

      if ((($a = (($b = Opal.cvars['@@song']) == null ? nil : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
        } else {
        (Opal.cvars['@@song'] = self.$game().$play_sound("music", true))
      };
      level_text = self.$game().$get_text("level" + (self.level_number));
      ...
      ($a = ($b = self.state.$level()).$each_cell, $a.$$p = (TMP_26 = function(pos, cell){var self = TMP_26.$$s || this, $a, $b, $case = nil;
        if (self.state == null) self.state = nil;
if (pos == null) pos = nil;if (cell == null) cell = nil;
      return (function() {$case = cell.$type();if ("player"['$===']($case)) {(($a = [$scope.get('Entity').$new($hash2(["pos", "animation", "sort_order"], {"pos": pos.$dup(), "animation": $scope.get('Animation').$new($hash2(["image_key"], {"image_key": "player"})), "sort_order": self.$so("player")}))]), $b = self.state, $b['$player='].apply($b, $a), $a[$a.length-1]);
        return (($a = ["floor"]), $b = cell, $b['$type='].apply($b, $a), $a[$a.length-1]);}else if ("enemy"['$===']($case)) {self.state.$entities()['$<<']($scope.get('Entity').$new($hash2(["pos", "ai", "animation", "sort_order"], {"pos": pos.$dup(), "ai": $scope.get('ChaserAi').$new(), "animation": $scope.get('Animation').$new($hash2(["image_key"], {"image_key": "chaser"})), "sort_order": self.$so("enemy")})));
        return (($a = ["floor"]), $b = cell, $b['$type='].apply($b, $a), $a[$a.length-1]);}else if ("shooter"['$===']($case)) {self.state.$entities()['$<<']($scope.get('Entity').$new($hash2(["pos", "ai", "animation", "sort_order"], {"pos": pos.$dup(), "ai": $scope.get('ShooterAi').$new(), "animation": $scope.get('Animation').$new($hash2(["image_key"], {"image_key": "shooter"})), "sort_order": self.$so("enemy")})));
        return (($a = ["floor"]), $b = cell, $b['$type='].apply($b, $a), $a[$a.length-1]);}else if ("goal"['$===']($case)) {(($a = [$scope.get('Entity').$new($hash2(["pos", "animation", "sort_order"], {"pos": pos.$dup(), "animation": $scope.get('Animation').$new($hash2(["image_key", "secs_per_frame"], {"image_key": "goal", "secs_per_frame": 0.2})), "sort_order": self.$so("goal")}))]), $b = self.state, $b['$goal='].apply($b, $a), $a[$a.length-1]);
        return (($a = ["floor"]), $b = cell, $b['$type='].apply($b, $a), $a[$a.length-1]);}else if ("dirtball"['$===']($case)) {self.state.$entities()['$<<']($scope.get('Entity').$new($hash2(["pos", "animation", "pushable", "sort_order"], {"pos": pos.$dup(), "animation": $scope.get('Animation').$new($hash2(["image_key"], {"image_key": "dirtball"})), "pushable": true, "sort_order": self.$so("dirtball")})));
        return (($a = ["floor"]), $b = cell, $b['$type='].apply($b, $a), $a[$a.length-1]);}else if ("teleporter"['$===']($case)) {self.state.$entities()['$<<']($scope.get('Entity').$new($hash2(["pos", "animation", "teleport_pair", "deadly", "sort_order"], {"pos": pos.$dup(), "animation": $scope.get('Animation').$new($hash2(["image_key"], {"image_key": "teleporter"})), "teleport_pair": 1, "deadly": false, "sort_order": self.$so("teleporter")})));
        return (($a = ["floor"]), $b = cell, $b['$type='].apply($b, $a), $a[$a.length-1]);}else { return nil }})()}, TMP_26.$$s = self, TMP_26), $a).call($b);
      ($a = ($c = self.state.$level()).$each_cell, $a.$$p = (TMP_27 = function(cell_pos, cell){var self = TMP_27.$$s || this, $a, $b, num_frames = nil;
if (cell_pos == null) cell_pos = nil;if (cell == null) cell = nil;
      num_frames = $scope.get('ANIMATIONS_FRAMES')['$[]'](cell.$type());
        ...
        (($a = [self.$game().$add_sprite(cell.$type()['$+'](cell.$image_frame().$to_s()))]), $b = cell, $b['$sprite='].apply($b, $a), $a[$a.length-1]);
        ...
        return (($a = [$scope.get('ORIENTATION_ROTATIONS').$fetch(cell.$orientation())]), $b = cell.$sprite(), $b['$rotation='].apply($b, $a), $a[$a.length-1]);}, TMP_27.$$s = self, TMP_27), $a).call($c);
      all_entities = self.state.$entities()['$+']([self.state.$player(), self.state.$goal()]);
      ($a = ($d = all_entities).$each, $a.$$p = (TMP_28 = function(e){var self = TMP_28.$$s || this, $a, $b;
if (e == null) e = nil;
      (($a = [self.$game().$add_sprite(e.$animation().$image_key()['$+'](e.$animation().$current_frame().$to_s()))]), $b = e, $b['$sprite='].apply($b, $a), $a[$a.length-1]);
        ...
        return e.$sprite().$scale()['$eset!']($scope.get('GRID_SIZE')['$/'](e.$sprite().$width()), $scope.get('GRID_SIZE')['$/'](e.$sprite().$height()));}, TMP_28.$$s = self, TMP_28), $a).call($d);
      ($a = ($e = ($f = ($g = all_entities).$sort_by, $f.$$p = "sort_order".$to_proc(), $f).call($g).$reverse()).$each, $a.$$p = (TMP_29 = function(e){var self = TMP_29.$$s || this;
if (e == null) e = nil;
      return e.$sprite().$bring_to_top()}, TMP_29.$$s = self, TMP_29), $a).call($e);
    ...
    def.$key_down = function(key) {
      ...
      if (self.state.$movement_sets().$size()['$=='](0)) {
        return (function() {$case = key;if ($scope.get('KEY_UP')['$===']($case)) {return self.$move_player("north")}else if ($scope.get('KEY_DOWN')['$===']($case)) {return self.$move_player("south")}else if ($scope.get('KEY_LEFT')['$===']($case)) {return self.$move_player("west")}else if ($scope.get('KEY_RIGHT')['$===']($case)) {return self.$move_player("east")}else if ($scope.get('KEY_SPACEBAR')['$===']($case)) {return self.$move_player("pass")}else if ($scope.get('KEY_N')['$===']($case)) {return $scope.get('LevelScene').$new(self.$next_level())}else if ($scope.get('KEY_P')['$===']($case)) {return $scope.get('LevelScene').$new(self.$next_level(-1))}else if ($scope.get('KEY_Z')['$===']($case)) {return $scope.get('LevelScene').$new(self.level_number)}else { return nil }})()
        } else {
        return nil
      };
    };
    ...
    def.$pointer_up = function(pointer) {
      var self = this, direction = nil;

      direction = self.$swipe_direction(pointer);
      if (direction !== false && direction !== nil) {
    ...
    def.$swipe_direction = function(pointer) {
      var self = this, delta = nil;
    ...
    def.$next_level = function(diff) {
      var self = this;

      if (diff == null) {
        diff = 1
      }
      return (self.level_number['$+'](diff))['$%']($scope.get('NUM_LEVELS'));
    };

    def.$move_player = function(direction) {
      var $a, $b, self = this, $case = nil, dx = nil, dy = nil, move_set = nil, did_move = nil, idx = nil, enemy = nil, ai_results = nil;

      $a = Opal.to_ary((function() {$case = direction;if ("north"['$===']($case)) {return [0, -1]}else if ("east"['$===']($case)) {return [1, 0]}else if ("south"['$===']($case)) {return [0, 1]}else if ("west"['$===']($case)) {return [-1, 0]}else if ("pass"['$===']($case)) {return [0, 0]}else {return self.$raise($scope.get('ArgumentError'), direction)}})()), dx = ($a[0] == null ? nil : $a[0]), dy = ($a[1] == null ? nil : $a[1]);
      move_set = $scope.get('MovementSet').$new();
      did_move = self.$try_move(self.state.$player(), dx, dy, move_set);
      if (did_move !== false && did_move !== nil) {
        (($a = [false]), $b = self.state.$player(), $b['$just_teleported='].apply($b, $a), $a[$a.length-1])};
      idx = 0;
      while (idx['$<'](self.state.$entities().$size())) {
      enemy = self.state.$entities()['$[]'](idx);
      if ((($b = enemy.$ai()) !== nil && (!$b.$$is_boolean || $b == true))) {
        ai_results = enemy.$ai().$think(enemy, self.state);
        if (ai_results !== false && ai_results !== nil) {
          self.$apply_ai(enemy, ai_results, move_set)};};
      idx = idx['$+'](1);};
      if (move_set.$movements().$size()['$>'](0)) {
        return self.state.$movement_sets()['$<<'](move_set)
        } else {
        return nil
      };
    };
    ...
    def.$apply_ai = function(entity, ai_results, move_set) {
      var $a, $b, TMP_30, $c, TMP_31, $d, TMP_32, self = this;

      ($a = ($b = ai_results.$moves()).$each, $a.$$p = (TMP_30 = function(move){var self = TMP_30.$$s || this, $a;
if (move == null) move = nil;
      ...
      ($a = ($c = ai_results.$spawns()).$each, $a.$$p = (TMP_31 = function(entity){var self = TMP_31.$$s || this, $a, $b;
        if (self.state == null) self.state = nil;
if (entity == null) entity = nil;
      (($a = [self.$game().$add_sprite(entity.$animation().$image_key()['$+'](entity.$animation().$current_frame().$to_s()))]), $b = entity, $b['$sprite='].apply($b, $a), $a[$a.length-1]);
        ...
        return self.state.$entities()['$<<'](entity);}, TMP_31.$$s = self, TMP_31), $a).call($c);
      return ($a = ($d = ai_results.$kills()).$each, $a.$$p = (TMP_32 = function(entity){var self = TMP_32.$$s || this, $a, $b;
if (entity == null) entity = nil;
      return (($a = [false]), $b = entity, $b['$alive='].apply($b, $a), $a[$a.length-1])}, TMP_32.$$s = self, TMP_32), $a).call($d);
    };

    def.$try_move = function(entity, dx, dy, move_set) {
      var $a, $b, TMP_33, $c, self = this, x = nil, y = nil, existing = nil;

      x = entity.$pos().$x()['$+'](dx);
      y = entity.$pos().$y()['$+'](dy);
      if ((($a = ((($b = y['$<'](0)) !== false && $b !== nil) ? $b : y['$>='](self.state.$level().$row_count()))) !== nil && (!$a.$$is_boolean || $a == true))) {
        return nil};
      ...
      if ((($a = self.state.$level()['$can_move_to?'](x, y)) !== nil && (!$a.$$is_boolean || $a == true))) {
        existing = ($a = ($b = self.state.$entities()).$find, $a.$$p = (TMP_33 = function(e){var self = TMP_33.$$s || this, $a;
if (e == null) e = nil;
        return ($a = e.$pushable(), $a !== false && $a !== nil ?e.$pos()['$eeql?'](x, y) : $a)}, TMP_33.$$s = self, TMP_33), $a).call($b);
        if ((($a = ((($c = existing['$!']()) !== false && $c !== nil) ? $c : self.$try_move(existing, dx, dy, move_set))) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          move_set.$movements()['$<<']($scope.get('Movement').$new($hash2(["entity", "from"], {"entity": entity, "from": $scope.get('Vec2')['$[]'](dx['$-@'](), dy['$-@']())})));
          return true;
          } else {
          return false
        };
    ...
    def.$update = function() {
      var $a, $b, TMP_34, $c, TMP_35, $d, $e, TMP_36, TMP_37, $f, TMP_38, $g, TMP_39, self = this, did_move = nil, teleporter = nil, other_teleporter = nil;

      self.$update_animation(self.state.$player());
      self.$update_animation(self.state.$goal());
      ($a = ($b = self.state.$entities()).$each, $a.$$p = (TMP_34 = function(entity){var self = TMP_34.$$s || this, $a;
if (entity == null) entity = nil;
      ...
      ($a = ($c = (self.state.$entities()['$+']([self.state.$player()]))).$each, $a.$$p = (TMP_35 = function(e){var self = TMP_35.$$s || this, $a, $b;
if (e == null) e = nil;
      e.$sprite().$position()['$eset!']((e.$pos().$x()['$+'](e.$pos_fraction().$x()))['$*']($scope.get('GRID_SIZE'))['$+']($scope.get('GRID_SIZE')['$/'](2)), (e.$pos().$y()['$+'](e.$pos_fraction().$y()))['$*']($scope.get('GRID_SIZE'))['$+']($scope.get('GRID_SIZE')['$/'](2)));
        return (($a = [$scope.get('ORIENTATION_ROTATIONS').$fetch(e.$orientation())]), $b = e.$sprite(), $b['$rotation='].apply($b, $a), $a[$a.length-1]);}, TMP_35.$$s = self, TMP_35), $a).call($c);
      if (did_move !== false && did_move !== nil) {
        return nil};
      ...
      } else if ((($a = ($d = ($e = self.state.$entities())['$any?'], $d.$$p = (TMP_36 = function(e){var self = TMP_36.$$s || this, $a;
        if (self.state == null) self.state = nil;
if (e == null) e = nil;
      return ($a = e.$deadly(), $a !== false && $a !== nil ?e.$pos()['$=='](self.state.$player().$pos()) : $a)}, TMP_36.$$s = self, TMP_36), $d).call($e)) !== nil && (!$a.$$is_boolean || $a == true))) {
        self.$game().$play_sound("lose");
        return $scope.get('EndLevelScene').$new("You lose", "red", "try again", self.level_number);};
      teleporter = ($a = ($d = self.state.$entities()).$find, $a.$$p = (TMP_37 = function(e){var self = TMP_37.$$s || this, $a;
        if (self.state == null) self.state = nil;
if (e == null) e = nil;
      return ($a = e.$teleport_pair(), $a !== false && $a !== nil ?e.$pos()['$=='](self.state.$player().$pos()) : $a)}, TMP_37.$$s = self, TMP_37), $a).call($d);
      if ((($a = (($f = teleporter !== false && teleporter !== nil) ? self.state.$player().$just_teleported()['$!']() : $f)) !== nil && (!$a.$$is_boolean || $a == true))) {
        ...
        other_teleporter = ($a = ($f = self.state.$entities()).$find, $a.$$p = (TMP_38 = function(e){var self = TMP_38.$$s || this, $a;
if (e == null) e = nil;
        return (($a = e.$teleport_pair()['$=='](teleporter.$teleport_pair())) ? e['$=='](teleporter)['$!']() : $a)}, TMP_38.$$s = self, TMP_38), $a).call($f);
        (($a = [other_teleporter.$pos().$dup()]), $g = self.state.$player(), $g['$pos='].apply($g, $a), $a[$a.length-1]);};
      return ($a = ($g = self.state.$entities())['$select!'], $a.$$p = (TMP_39 = function(e){var self = TMP_39.$$s || this, $a;
if (e == null) e = nil;
    ...
    return (def.$update_next_movement = function() {
      var $a, $b, TMP_40, self = this, move_set = nil;
      ...
      if (move_set !== false && move_set !== nil) {
        ...
        ($a = ($b = move_set.$movements()).$each, $a.$$p = (TMP_40 = function(m){var self = TMP_40.$$s || this, fraction = nil;
if (m == null) m = nil;
        fraction = m.$from().$lerp_to($scope.get('Vec2')['$[]'](0, 0), move_set.$progress());
          return m.$entity().$pos_fraction()['$set!'](fraction);}, TMP_40.$$s = self, TMP_40), $a).call($b);
  ...
  (function($base, $super) {
    ...
    var self = $EndLevelScene = $klass($base, $super, 'EndLevelScene', $EndLevelScene);

    var def = self.$$proto, $scope = self.$$scope;

    def.next_level = def.text = def.color = def.action_text = nil;
    def.$initialize = function(text, color, action_text, next_level) {
      var self = this;
      ...
      return self.next_level = next_level;
    };

    def.$key_down = function(key) {
      var self = this, $case = nil;

      return (function() {$case = key;if ($scope.get('KEY_SPACEBAR')['$===']($case)) {return $scope.get('LevelScene').$new(self.next_level)}else { return nil }})();
    };
    ...
    return (def.$startup = function() {
      var self = this, screen = nil, top = nil, bot = nil;

      screen = self.$game().$canvas_size();
      top = self.$game().$add_text(self.text, $hash2(["fill"], {"fill": self.color}));
      top.$position()['$eset!'](screen.$x()['$/'](2)['$-'](top.$width()['$/'](2)), screen.$y()['$/'](2));
      bot = self.$game().$add_text("Press space or tap to " + (self.action_text), $hash2(["fill"], {"fill": self.color}));
      return bot.$position()['$eset!'](screen.$x()['$/'](2)['$-'](bot.$width()['$/'](2)), screen.$y()['$/'](2)['$+'](80));
    }, nil) && 'startup';
  })(self, $scope.get('Scene'));
  (function($base, $super) {
    function $IntroScene(){};
    var self = $IntroScene = $klass($base, $super, 'IntroScene', $IntroScene);
    ...
    def.$startup = function() {
      ...
      return self.background = self.$game().$add_sprite("intro_background");
    };
